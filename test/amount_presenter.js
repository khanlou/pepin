...
describe("amount presenter", function() {
  ...
  it("should present amounts with two components with cups", function() {
    ...
    assert.equal(amountPresenter.amountForDisplay, "<sup class='frac'>1</sup>&frasl;<sub class='frac'>4</sub> cup + 2 tablespoons");
  ...
  it("should present amounts with two components with crazy cup size", function() {
    ...
    assert.equal(amountPresenter.amountForDisplay, "<sup class='frac'>1</sup>&frasl;<sub class='frac'>4</sub> cup + 1 teaspoon");
